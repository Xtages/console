...
open class OrganizationRecord() : UpdatableRecordImpl<OrganizationRecord>(Organization.ORGANIZATION), Record4<String?, String?, OrganizationSubscriptionStatus?, Int?> {
    ...
    override fun valuesRow(): Row4<String?, String?, OrganizationSubscriptionStatus?, Int?> = super.valuesRow() as Row4<String?, String?, OrganizationSubscriptionStatus?, Int?>
    ...
    override fun values(value1: String?, value2: String?, value3: OrganizationSubscriptionStatus?, value4: Int?): OrganizationRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(name: String? = null, stripeCustomerId: String? = null, subscriptionStatus: OrganizationSubscriptionStatus? = null, ownerId: Int? = null): this() {
        this.name = name
