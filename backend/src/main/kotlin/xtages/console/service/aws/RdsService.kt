...
class RdsService(
    ...
    fun provisionServerless(organization: Organization) {
        ...
        val cluster = CreateDbClusterRequest.builder()
            ...
            .engine(consoleProperties.aws.rds.engine.postgresServerless)
            .engineVersion(consoleProperties.aws.rds.engineVersion.postgresServerless)
            ...
            .engineMode(consoleProperties.aws.rds.engine.mode)
            .dbSubnetGroupName(consoleProperties.aws.rds.dbSubnetGroupName)
            .scalingConfiguration(
                ScalingConfiguration.builder()
                    .minCapacity(consoleProperties.aws.rds.scaling.minCapacity)
                    .maxCapacity(consoleProperties.aws.rds.scaling.maxCapacity)
                    .autoPause(consoleProperties.aws.rds.scaling.autoPauseEnable)
                    .secondsUntilAutoPause(consoleProperties.aws.rds.scaling.secondsUntilAutoPause)
                    .build()
            )
            .tags(
    ...
    fun provisionDbInstance(organization: Organization) {
        ...
        val instanceRequest = CreateDbInstanceRequest.builder()
            ...
            .engine(consoleProperties.aws.rds.engine.postgres)
            .dbInstanceClass(plan.dbInstance)
            .engineVersion(consoleProperties.aws.rds.engineVersion.postgres)
